            ...
            <ul className="dropdown__list" style={{ display: isOpen ? 'block' : 'none' }}>
                {filteredOptions.map((option, index) => (
                    <li key={index} className="dropdown__item">
                        ...
                        >
                            <svg style={{ "opacity": selectedOption === option ? 1 : 0 }} viewBox="0 0 24 24" width="16" height="16" xmlns="http://www.w3.org/2000/svg">
                                <path d="M18.71,7.21a1,1,0,0,0-1.42,0L9.84,14.67,6.71,11.53A1,1,0,1,0,5.29,13l3.84,3.84a1,1,0,0,0,1.42,0l8.16-8.16A1,1,0,0,0,18.71,7.21Z" fill="#df6d21" />
                            </svg>
                            {option.toString()}
                        </button>
                    </li>
